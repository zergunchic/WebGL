...
vec2 st = gl_FragCoord.xy/u_resolution;
  ...
  // Plot a line
  float pct = plot(st,y);
  color = (1.0-pct)*color+pct*vec3(0.5,0.0,0.94);
...
function renderLoop(timeStamp){
  // set time uniform
  let timeShaderUniform = gl.getUniformLocation(program, "u_time");
  let mousePosUniform = gl.getUniformLocation(program,"u_mouse");
